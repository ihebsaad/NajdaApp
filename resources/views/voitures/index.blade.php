...
@section('content')
    ...
    <div class="uper">
        ...
        <div class="portlet box grey">
            <div class="row">
                <div class="col-lg-6">Véhicules</div>
                <div class="col-lg-6">
                    <button id="addgr" class="btn btn-md btn-success"   data-toggle="modal" data-target="#create"><b><i class="fas fa-plus"></i> Ajouter une véhicule</b></button>
                </div>
            </div>
        </div>
        ...
        <table class="table table-striped" id="mytable" style="width:100%">
            ...
            @foreach($voitures as $voiture)
                ...
                <tr>
					...
					<td    >
                        @can('isAdmin')
                            <a  href="{{action('VoituresController@destroy', $voiture['id'])}}" class="btn btn-danger btn-sm btn-responsive " role="button" data-toggle="tooltip" data-tooltip="tooltip" data-placement="bottom" data-original-title="Supprimer" >
