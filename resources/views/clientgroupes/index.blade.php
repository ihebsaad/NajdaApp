        ...
        <table class="table table-striped" id="mytable" style="width:100%">
            ...
            @foreach($clientgroupes as $clientgroupe)
                ...
                <tr>
					...
					<td    >
                        @can('isAdmin')
                            <a  href="{{action('ClientGroupesController@destroy', $clientgroupe['id'])}}" class="btn btn-danger btn-sm btn-responsive " role="button" data-toggle="tooltip" data-tooltip="tooltip" data-placement="bottom" data-original-title="Supprimer" >
