...
//echo 'Max Id : '.DossiersController::GetMaxIdBytypeN();
    ...
    <div class="uper">
        <div class="portlet box grey">
             <div class="row">
                <div class="col-lg-8"> <h4>Dossiers du client : <?php echo  DossiersController::ClientById($idcl); ?></h4></div>
                <div class="col-lg-4">
        ...
        <table class="table table-striped" id="mytable" style="width:100%">
            ...
            <tr id="headtable">
                ...
                <th style="width:10%">Création</th>
                <th style="width:20%">Assuré</th>
                <th style="width:10%">Type de dossier</th>
            ...
            @foreach($dossiers as $dossier)
                <tr><?php $statut=$dossier['current_status'];  $affecte=$dossier['affecte'];   ?>
                    ...
                    ;?>
                    <td style="width:20%"><a href="{{action('DossiersController@view', $dossier['id'])}}" >{{$dossier->reference_medic}}</a> <a style="color:#a0d468" href="{{action('DossiersController@fiche', $dossier['id'])}}" >Fiche<i class="fa fa-file-txt"></i></a></td>
                    <td style="width:10%">
                        créé par <B><?php echo $creator ;?></B> - Date: <?php echo $createdat ; ?>
                    </td>
                    <td style="width:20%"><?php echo '<small>'.$dossier['subscriber_name'] .' '.$dossier['subscriber_lastname'] .'</small>';?></td>
                    <td style="width:10%">
                        <?php $type= $dossier['type_dossier']; echo '<small>'. $type.'</small>';?>
                    </td>
