...
@section('content')
    ...
    <div class="uper">
         <div class="portlet box grey">
            <div class="row">
                <div class="col-lg-6">Types de prestations</div>
                <div class="col-lg-6">
                    <button id="addgr" class="btn btn-md btn-success"   data-toggle="modal" data-target="#create"><b><i class="fas fa-plus"></i> Ajouter un type de prestation</b></button>
                </div>
            </div>
        </div>
        <table class="table table-striped" id="mytable" style="width:100%">
            ...
            @foreach($typeprestations as $typeprestation)
                <?php
                $thetype=$typeprestation['type'];
                if($thetype==0){$type="Indéterminé";}
                if($thetype==1){$type="Technique";}
                if($thetype==2){$type="Médical";}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ajouter un Type de prestation</h5>
