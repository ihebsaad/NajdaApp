            ...
            @foreach($rubriques as $rubrique)
                ...
                <tr>
                    <td  ><?php echo sprintf("%04d",$rubrique->id);?></td>
 					<td><input type="text" class="form-control" style="width:100%" value="<?php echo $rubrique->nom ; ?>" onchange="updating(<?php echo $rubrique->id;?>,'nom',this)" /></td>
 					<td><input type="text" class="form-control" style="width:100%" value="<?php echo $rubrique->commentaire ; ?>" onchange="updating(<?php echo $rubrique->id;?>,'commentaire',this)" /></td>
                        ...
                        <form method="post" >
						   ...
						   <div class="form-group">
                                <label for="nom">Nom :</label>
                                 <input class="form-control" type="text" id="nomrubrique" />
	     ...
	     $('#add').click(function(){
                 ...
                 if ((nom != '')  )
                {
                    ...
                    $.ajax({
                        ...
                        method:"POST",
                        data:{garantie:garantie,nom:nom,commentaire:commentaire,montant:montant,devise:devise , _token:_token},
                        success:function(data){
