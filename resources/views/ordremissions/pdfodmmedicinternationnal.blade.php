...
<?php if (isset($_POST['CL_hotel_aeroport'])) { if ($_POST['CL_hotel_aeroport'] === "hôtel") { ?>
				 </span><span style="font-family:'Times New Roman'">où une chambre est réservée en votre nom pour la nuitée du </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'"> </span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_debut_res'])) { $DHsansT =str_replace('T',' ',$_POST['CL_debut_res']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} }  ?></span> </span>
