...
<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Date de decollage: &#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_date_decollage'])) { if($_POST['CL_date_decollage']==='') {echo '';} else {echo date('d/m/Y', strtotime($_POST['CL_date_decollage'])) ; }   } ?></span>
<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Heure de prise en charge annoncée au patient/client : &#xa0;</span><span style="font-family:'Times New Roman'"><?php  if (isset($_POST['CL_date_heure_prise'])) {$DHsansT =str_replace('T',' ',$_POST['CL_date_heure_prise']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));}  }?></span><p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Heure départ clinique/Hôpital/Hôtel : &#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_date_heure_departclinique'])) {$DHsansT =str_replace('T',' ',$_POST['CL_date_heure_departclinique']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} } ?></span>
	...
	<?php if (isset($_POST['CL_puces'])) { 
			...
			for ($i=0; $i < $len; $i++)
			{
				if ($_POST['CL_puces'][$i] !== "")
				{
					...
					echo '<span class=rvts42>'. $puceinfo['nom']." [".$puceinfo['reference']."]" ." : ".$puceinfo['numero'] . '</span>';
...
<p class=rvps9><span class=rvts42>Le patient voyage <span class=rvts42> <?php if (isset($_POST['CL_chaise'])) { echo $_POST['CL_chaise']; } ?></span></p>
<p class=rvps1><span class=rvts2><br></span></p>
<div class="row" style=" margin-left: 0px; ">
	<p style="margin-top: 0pt;margin-bottom:0pt; widows:0; orphans:0; font-size:10pt">
	<span style="font-family:'Times New Roman'; font-weight:bold">Vous prendrez le vol </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'">  </span><span style="font-family:'Times New Roman'; "><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_vol'])) { echo $_POST['CL_vol']; } ?></span>
				 </span><span style="font-family:'Times New Roman'">qui décolle de l’aéroport de </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'"> </span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_lieu_dec'])) { echo $_POST['CL_lieu_dec']; } ?></span> </span><span style="font-family:'Times New Roman'">à </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'"> </span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_date_heure_decollage'])) {$DHsansT =str_replace('T',' ',$_POST['CL_date_heure_decollage']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} }  ?></span>
	</p>
</div>
<div class="row" style=" margin-left: 0px; ">
	<p style="margin-top: 0pt;margin-bottom:0pt; widows:0; orphans:0; font-size:10pt">
...
<div class="row" style=" margin-left: 0px; ">
<?php if (isset($_POST['CB_accepte'])) { if (($_POST['CB_accepte'] === "oui")||($_POST['CB_accepte'] === "on")) { ?>	
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_accepte'])) { echo $_POST['CL_accepte']; } ?></span>
</span>
</p>
<?php }} ?>
...
<div class="row" style=" margin-left: 0px; ">
	<p style="margin-top: 0pt;margin-bottom:0pt; widows:0; orphans:0; font-size:10pt">
	<span style="font-family:'Times New Roman'; font-weight:bold">La même ambulance/un taxi  assurera votre transfert à l’</span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'">  </span><span style="font-family:'Times New Roman'; "><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_hotel_aeroport'])) { echo $_POST['CL_hotel_aeroport']; } ?></span>
<?php if (isset($_POST['CL_hotel_aeroport'])) { if ($_POST['CL_hotel_aeroport'] === "hôtel") { ?>
				 </span><span style="font-family:'Times New Roman'"><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_nomhotel'])) { echo $_POST['CL_nomhotel']; } ?></span> où une chambre est réservée en votre nom pour la nuitée du </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'"> </span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_debut_res'])) { $DHsansT =str_replace('T',' ',$_POST['CL_debut_res']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} }  ?></span> </span>
	<span style="font-family:'Times New Roman'; font-weight:bold"> au </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'">  </span><span style="font-family:'Times New Roman'; "><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_fin_res'])) {$DHsansT =str_replace('T',' ',$_POST['CL_fin_res']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} }?></span>
 </span>
<?php }} ?>
<?php if (isset($_POST['CL_hotel_aeroport'])) { if ($_POST['CL_hotel_aeroport'] === "aéroport") { ?>
				 </span><span style="font-family:'Times New Roman'"> d’où vous prendrez le vol </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'"> </span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_prendre_vol'])) { echo $_POST['CL_prendre_vol'];  } ?></span> </span>
	<span style="font-family:'Times New Roman'; font-weight:bold"> qui décolle à </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'">  </span><span style="font-family:'Times New Roman'; "><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_date_heure_decollage2'])) {$DHsansT =str_replace('T',' ',$_POST['CL_date_heure_decollage2']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} }?></span>
 </span>
<?php }} ?>
	</p>
</div>
<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Date de Retour : &#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_date_retour'])) {if($_POST['CL_date_retour']==='') {echo '';} else {echo date('d/m/Y', strtotime($_POST['CL_date_retour'])) ; } } ?></span>
...
<div class="row" style=" margin-left: 0px; ">
	<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Heure prévue de votre arrivée à la base: &#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_date_heure_arrivebase'])) {$DHsansT =str_replace('T',' ',$_POST['CL_date_heure_arrivebase']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} } ?></span>
