...
<div class="row" style=" margin-left: 0px; ">
	<p style="margin-top:6.65pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt"><span style="font-family:'Times New Roman'; font-weight:bold">Etat de véhicule</span><span style="font-family:'Times New Roman'; font-weight:bold"></span><span style="font-family:'Times New Roman'; font-weight:bold">&#xa0;</span><span style="font-family:'Times New Roman'; font-weight:bold">: </span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_etat_vehicule'])) { echo $_POST['CL_etat_vehicule']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_heure_D_'])) { echo $_POST['CL_heure_D']; } ?></span>
</span>			
</p>
<?php }} ?>
...
<?php if (isset($detailom['CB_pregoulette']) || isset($detailom['CL_prerades'])) { if ((($detailom['CB_prerades'] === "oui"||($detailom['CB_prerades'] === "on")))||(($detailom['CB_pregoulette'] === "oui")||($detailom['CB_pregoulette'] === "on"))){ ?>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_heurearr'])) { echo $_POST['CL_heurearr']; } ?></span>
					<span style="font-family:'Times New Roman'"> Si vers Port de la Goulette par défaut heure départ -3 hueres si vers </span><span style="font-family:'Times New Roman'">l’</span><span style="font-family:'Times New Roman'">Port de Rades par défaut RDV au port à 8h. </span><span style="font-family:'Times New Roman'"></span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'"></span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'">». S</span><span style="font-family:'Times New Roman'"> </span>
</p>
