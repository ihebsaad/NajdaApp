...
<body>
<div class="row" style="margin-bottom: -150px;padding-bottom: 10px">
...
<p style="margin-top:-40px!important; margin-left:2.85pt; margin-bottom:5px; widows:0; orphans:0; font-size:12pt"><span style="font-family:'Times New Roman'; font-weight:bold; font-style:italic; color:#000000">Le présent ordre de mission fait office de prise en charge et copie doit être adressée avec votre facture</span></p>
...
<div class="row" style=" margin-left: 0px; ">
	<p style="margin-top:6.65pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt"><span style="font-family:'Times New Roman'; font-weight:bold">Véhicule (marque et type) </span><span style="font-family:'Times New Roman'; font-weight:bold"></span><span style="font-family:'Times New Roman'; font-weight:bold">&#xa0;</span><span style="font-family:'Times New Roman'; font-weight:bold">: </span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['vehicule_type'])) { echo $_POST['vehicule_type']; } ?></span>
...
<div class="row" >
	<div id="compsup" class="col-md-3" style="width:35%;padding-bottom:10px;border-style: groove;"><p style="margin-top:5px; margin-left:5.75pt; margin-bottom:0pt; text-indent:15.55pt; line-height:10.05pt; widows:0; orphans:0"><span style="font-family:&#39;Times New Roman&#39;; font-size:9pt; font-weight:bold;margin-top:5px!important; ">Valid.</span><span style="font-family:&#39;Times New Roman&#39;; font-size:9pt; font-weight:bold">superviseur</span></p><p style="margin-top:0pt; margin-bottom:0pt; text-indent:21.3pt;">
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['supervisordate'])) { echo $_POST['supervisordate']; } ?></span>
		</p><p style="margin-top:1.05pt; margin-bottom:0pt; widows:0; orphans:0; font-size:8pt"></p><p style="margin:0pt 0pt 0pt 5.75pt; text-indent:15.55pt; margin-top:15px; widows:0; orphans:0; font-size:9pt;font-family:&#39;Times New Roman&#39;; font-weight:bold">OM remis par (date/sign)</p><p style="margin-top:0pt; margin-bottom:0pt; text-indent:21.3pt; margin-top:0px; widows:0; orphans:0">
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['remispardate'])) { echo $_POST['remispardate']; } ?></span>
		</p><p style="margin:0pt 0pt 0pt 5.75pt; text-indent:15.55pt; margin-top:5px; widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">OM récupéré par (date/sign)</span></p><p style="margin-top:0pt; margin-bottom:0pt; text-indent:21.3pt; margin-top:0px; ">
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['recuperepardate'])) { echo $_POST['recuperepardate']; } ?></span>
	</p></div>
	<div id="modtransp" class="col-md-3" style="left:400px!important;width:40%;border-style: groove;">
		<p style="margin-top:0pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"></p><p style="margin-top:5px; margin-left:6.9pt; margin-bottom:0pt; text-indent:14.4pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold; text-decoration:underline">Modalités du transport</span></p><p style="margin-top:0pt; margin-bottom:0pt; text-indent:14.4pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">&nbsp;</span></p><p style="margin-top:7.15pt; margin-left:6.9pt; margin-bottom:0pt; text-indent:14.4pt; widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Date</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">/heure</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold"> départ base:</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold; letter-spacing:0.65pt;"> </span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['heuressup'])) { echo $_POST['heuressup']; } ?></span>
	...
	<div id="deroulmiss" class="deroulmiss col-md-3" style="top: 150px!important;width:35%;padding-bottom:0px;border-style: groove;z-index:1000;">
		<p style="margin-top:5pt;  margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold; text-decoration:underline">Déroulement mission</span></p><p style="margin:0pt 120.4pt 0pt 120.3pt; text-indent:-120.3pt; widows:0; orphans:0; font-size:14pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">&nbsp;</span></p><p style="margin:4.65pt 120.4pt 0pt 238.7pt; text-indent:-224.5pt; widows:0; orphans:0; font-size:9pt;width:100%"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Départ </span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">pour mission: </span>
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dhdepartmiss'])) { $DHsansT =str_replace('T',' ',$_POST['dhdepartmiss']); echo $DHsansT; } ?></span>
		</p><p style="font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Arrivée</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold"> </span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">&nbsp;lieux: </span>
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dharrivelieu'])) { $DHsansT =str_replace('T',' ',$_POST['dharrivelieu']); echo $DHsansT; } ?></span>
		</p><p style=" font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Départ lieux: </span>
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dhdepartlieu'])) { $DHsansT =str_replace('T',' ',$_POST['dhdepartlieu']); echo $DHsansT; } ?></span>
		</p><p style=" font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Arrivée</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold"> à</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold"> destination: </span>
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dharrivedest'])) { $DHsansT =str_replace('T',' ',$_POST['dharrivedest']); echo $DHsansT; } ?></span>
		...
		</p><p style="font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Départ</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold; letter-spacing:-1pt"> </span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">vers </span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">base:</span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['km_depart'])) { echo $_POST['km_depart']; } ?></span>
		</p><p style="margin:0pt 120.4pt 0pt 223.5pt; text-indent:-188.05pt; widows:0; orphans:0; font-size:9pt;top:10px!important"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">K</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">m</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold"> arrivée</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">: </span>
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['km_arrive'])) { echo $_POST['km_arrive']; } ?></span>
		</p><p style="font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">&nbsp;</span></p><p style="margin:0pt 120.4pt 0pt 170.5pt; text-indent:-156.3pt; widows:0; orphans:0; font-size:9pt;width:120%"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Distance </span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">réelle mission </span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">(km): </span>
