...
</div><p style="margin-top:-140px!important;line-height:30%; margin-left:2.85pt; margin-bottom:5px; widows:0; orphans:0;  font-size:14pt;color:red;"><span style="font-family:'Times New Roman'; font-weight:bold">Ce document annule l'ordre de mission ci-dessous en date du : <?php echo $omparent['created_at']; ?></span></p>
...
<div class="row" style=" margin-left: 0px; ">
	<p style="margin-top:6.65pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt"><span style="font-family:'Times New Roman'; font-weight:bold">Véhicule (marque et type) </span><span style="font-family:'Times New Roman'; font-weight:bold"></span><span style="font-family:'Times New Roman'; font-weight:bold">&#xa0;</span><span style="font-family:'Times New Roman'; font-weight:bold">: </span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['vehicule_type'])) { echo $omparent['vehicule_type']; } ?></span>
...
<div class="row" style=" margin-left: 0px; ">
			<p style="margin-top:6.65pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt"><span style="font-family:'Times New Roman'; font-weight:bold">RDV avec </span><span style="font-family:'Times New Roman'; font-weight:bold">le passager</span><span style="font-family:'Times New Roman'; font-weight:bold">&#xa0;</span><span style="font-family:'Times New Roman'; font-weight:bold">: </span><span style="font-family:'Times New Roman'; font-weight:bold"><?php if (isset($omparent['CL_heure_RDV'])) { echo $omparent['CL_heure_RDV']; } ?></span>
