...
<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Date, heure et lieu de départ pour votre mission: &#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_date_heure_departmission'])) {$DHsansT =str_replace('T',' ',$omparent['CL_date_heure_departmission']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} }?></span>
<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Date de decollage: &#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_date_decollage'])) { if($omparent['CL_date_decollage']==='') {echo '';} else {echo date('d/m/Y', strtotime($omparent['CL_date_decollage'])) ; } } ?></span>
<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Heure de prise en charge annoncée au patient/client : &#xa0;</span><span style="font-family:'Times New Roman'"><?php  if (isset($omparent['CL_date_heure_prise'])) {$DHsansT =str_replace('T',' ',$omparent['CL_date_heure_prise']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} }?></span><p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Heure départ clinique/Hôpital/Hôtel : &#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_date_heure_departclinique'])) {$DHsansT =str_replace('T',' ',$omparent['CL_date_heure_departclinique']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} } ?></span>
	...
	<?php foreach ($parentsims as $psim) {
             foreach ($array_puces as $puced) {
              if ( $puced['id']=== $psim['idequipement']){
					echo $puced['nom']." [".$puced['reference']."]"." : ".$puced['numero'] ."  ";
...
<div class="row" style=" margin-left: 0px; ">
	...
	<span style="font-family:'Times New Roman'; font-weight:bold">Vous prendrez le vol </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'">  </span><span style="font-family:'Times New Roman'; "><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_vol'])) { echo $omparent['CL_vol']; } ?></span>
				 </span><span style="font-family:'Times New Roman'">qui décolle de l’aéroport de </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'"> </span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_lieu_dec'])) { echo $omparent['CL_lieu_dec']; } ?></span> </span><span style="font-family:'Times New Roman'">à </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'"> </span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_date_heure_decollage'])) {$DHsansT =str_replace('T',' ',$omparent['CL_date_heure_decollage']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} }  ?></span>
	</p>
</div>
<div class="row" style=" margin-left: 0px; ">
	<p style="margin-top: 0pt;margin-bottom:0pt; widows:0; orphans:0; font-size:10pt">
...
<div class="row" style=" margin-left: 0px; ">
<?php if (isset($omparent['CB_accepte'])) { if (($omparent['CB_accepte'] === "oui")||($omparent['CB_accepte'] === "on")) { ?>	
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_accepte'])) { echo $omparent['CL_accepte']; } ?></span>
</span>
</p>
<?php }} ?>
</div>
<div class="row" style=" margin-left: 0px; ">
	<p style="margin-top: 0pt;margin-bottom:0pt; widows:0; orphans:0; font-size:10pt">
	<span style="font-family:'Times New Roman'; font-weight:bold">La même ambulance/un taxi  assurera votre transfert à l’</span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'">  </span><span style="font-family:'Times New Roman'; "><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_hotel_aeroport'])) { echo $omparent['CL_hotel_aeroport']; } ?></span>
<?php if (isset($omparent['CL_hotel_aeroport'])) { if ($omparent['CL_hotel_aeroport'] === "hôtel") { ?>
				 </span><span style="font-family:'Times New Roman'"> <span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_nomhotel'])) { echo $omparent['CL_nomhotel']; } ?></span> où une chambre est réservée en votre nom pour la nuitée du </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'"> </span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_debut_res'])) { $DHsansT =str_replace('T',' ',$omparent['CL_debut_res']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} }  ?></span> </span>
	<span style="font-family:'Times New Roman'; font-weight:bold"> au </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'">  </span><span style="font-family:'Times New Roman'; "><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_fin_res'])) {$DHsansT =str_replace('T',' ',$omparent['CL_fin_res']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} }?></span>
 </span>
<?php }} ?>
<?php if (isset($omparent['CL_hotel_aeroport'])) { if ($omparent['CL_hotel_aeroport'] === "aéroport") { ?>
				 </span><span style="font-family:'Times New Roman'"> d’où vous prendrez le vol </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'"> </span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_prendre_vol'])) { echo $omparent['CL_prendre_vol'];  } ?></span> </span>
	<span style="font-family:'Times New Roman'; font-weight:bold"> qui décolle à </span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'">  </span><span style="font-family:'Times New Roman'; "><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_date_heure_decollage2'])) {$DHsansT =str_replace('T',' ',$omparent['CL_date_heure_decollage2']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} }?></span>
 </span>
<?php }} ?>
	</p>
</div>
<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Date de Retour : &#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_date_retour'])) {if($omparent['CL_date_retour']==='') {echo '';} else {echo date('d/m/Y', strtotime($omparent['CL_date_retour'])) ; } } ?></span>
...
<div class="row" style=" margin-left: 0px; ">
	<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Heure prévue de votre arrivée à la base: &#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_date_heure_arrivebase'])) {$DHsansT =str_replace('T',' ',$omparent['CL_date_heure_arrivebase']); if($DHsansT ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($DHsansT));} } ?></span>
