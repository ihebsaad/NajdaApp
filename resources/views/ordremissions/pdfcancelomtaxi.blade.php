...
<p style="margin-top:-40px!important;line-height:30%; margin-left:2.85pt; margin-bottom:5px; widows:0; orphans:0;  font-size:12pt;color:red;"><span style="font-family:'Times New Roman'; font-weight:bold">Ce document annule l'ordre de mission ci-dessous en date du : <?php echo $omparent['created_at']; ?></span></p>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dhdepbase'])) { $DHsansT =str_replace('T',' ',$omparent['dhdepbase']);  echo date('d/m/Y H:i:s', strtotime($DHsansT)); } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dharrbase'])) {$DHsansT =str_replace('T',' ',$omparent['dharrbase']);  echo date('d/m/Y H:i:s', strtotime($DHsansT)); } ?></span>
