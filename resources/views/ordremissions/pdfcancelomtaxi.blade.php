...
<p style="margin-top:-40px!important;line-height:30%; margin-left:2.85pt; margin-bottom:5px; widows:0; orphans:0;  font-size:12pt;color:red;"><span style="font-family:'Times New Roman'; font-weight:bold">Ce document annule l'ordre de mission au-dessous de la date : <?php echo $omparent['created_at']; ?></span></p>
...
<div class="row" style=" margin-left: 0px; ">
			<p style="margin-top:0.05pt; margin-bottom:0pt; widows:0; orphans:0; font-size:9pt"><span style="font-family:'Times New Roman'; font-weight:bold">RDV avec </span><span style="font-family:'Times New Roman'; font-weight:bold">le passager</span><span style="font-family:'Times New Roman'; font-weight:bold">&#xa0;</span><span style="font-family:'Times New Roman'; font-weight:bold">: </span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_heure_RDV'])) { echo $omparent['CL_heure_RDV']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_lieuprest_pc'])) { echo $omparent['CL_lieuprest_pc']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_lieudecharge_dec'])) { echo $omparent['CL_lieudecharge_dec']; } ?></span>
				<span style="font-family:'Times New Roman'; font-weight:bold">Tel: </span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_destorg'])) { echo $omparent['CL_destorg']; } ?></span>
			<span style="font-family:'Times New Roman'; font-weight:bold">: </span>
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_apdestor'])) { echo $omparent['CL_apdestor']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_volorbateau'])) { echo $omparent['CL_volorbateau']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_datedemande'])) { echo $omparent['CL_datedemande']; } ?></span>
						<span style="font-family:'Times New Roman'; font-weight:bold"> Heure: </span>
...
<span style="font-family:'Times New Roman';margin-left:40px;"><?php if (isset($omparent['dateheuredispprev'])) {$DHsansT =str_replace('T',' ',$omparent['dateheuredispprev']); echo $DHsansT;} ?></span></p><p style="margin-top:0.05pt; margin-left:3.9pt; margin-bottom:0pt; widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Date/heure retour base prévisible:</span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dhredepart'])) { $DHsansT =str_replace('T',' ',$omparent['dhredepart']); echo $DHsansT; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dh2emearrdest'])) { $DHsansT =str_replace('T',' ',$omparent['dh2emearrdest']); echo $DHsansT; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dhdepbase'])) { $DHsansT =str_replace('T',' ',$omparent['dhdepbase']); echo $DHsansT; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dharrbase'])) {$DHsansT =str_replace('T',' ',$omparent['dharrbase']); echo $DHsansT; } ?></span>
