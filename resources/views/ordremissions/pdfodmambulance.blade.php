...
<div class="row" style=" margin-left: 0px; ">
			<p style="margin-top:6.65pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt"><span style="font-family:'Times New Roman'; font-weight:bold">RDV avec </span><span style="font-family:'Times New Roman'; font-weight:bold">le passager</span><span style="font-family:'Times New Roman'; font-weight:bold">&#xa0;</span><span style="font-family:'Times New Roman'; font-weight:bold">: </span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_heure_RDV'])) { echo $_POST['CL_heure_RDV']; } ?></span>
...
<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Type d'ambulance : &#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_type_ambulance'])) { echo $_POST['CL_type_ambulance']; } ?></span>
<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Matériel Nécessaire :</span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold; letter-spacing:-0.7pt"> </span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold"></span>
<span style="font-family:'Times New Roman'; font-weight:bold;">  </span><span style="font-family:'Times New Roman'; font-size:10pt; font-weight:bold">O2 : </span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold"> </span><span style="font-family:'Times New Roman';font-size:10pt"><?php if (isset($_POST['CL_O2'])) { echo $_POST['CL_O2']; } else {echo "non";} ?></span>
					  <span style="font-family:'Times New Roman'; font-size:10pt; font-weight:bold"> Respirateur : </span><span style="font-family:'Times New Roman'; font-size:10pt"><?php if (isset($_POST['CL_respirateur'])) { echo $_POST['CL_respirateur']; } else {echo "non";} ?></span>
					 <span style="font-family:'Times New Roman'; font-size:10pt; font-weight:bold"> Couveuse : </span><span style="font-family:'Times New Roman'; font-size:10pt"><?php if (isset($_POST['CL_couveuse'])) { echo $_POST['CL_couveuse']; } else {echo "non";} ?></span>
					<span style="font-family:'Times New Roman'; font-size:10pt; font-weight:bold"> PSE : </span><span style="font-family:'Times New Roman'; font-size:10pt"><?php if (isset($_POST['CL_pse'])) { echo " oui"; if (isset($_POST['CL_nbpsemax'])) {echo " ;Nombre max de PSE : ".$_POST['CL_nbpsemax'];} } else {echo " non";} ?></span>
                      <span style="font-family:'Times New Roman'; font-size:10pt; font-weight:bold"> Chaise roulante : </span><span style="font-family:'Times New Roman'; font-size:10pt"><?php if (isset($_POST['CL_chaise_roulante'])) { echo $_POST['CL_chaise_roulante']; } else {echo "non";} ?></span>
	</p>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_prestatairetel_pc'])) { echo $_POST['CL_prestatairetel_pc']; } ?></span>
				<span style="font-family:'Times New Roman'; font-weight:bold; color:#ff0000">    </span></p><p style="margin-top:4.65pt; margin-left:5.85pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt"><span style="font-family:'Times New Roman'; font-weight:bold; color:#0070c0"> </span><span style="font-family:'Times New Roman'; font-weight:bold">Lieu décharge: </span>
...
<p id="preportaeroport1" style="margin-top:4.65pt; margin-left:5.85pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt"><span style="font-family:'Times New Roman'; font-weight:bold">Type de siége: </span><span style="font-family:'Times New Roman'; font-weight:bold"> </span>
...
<div class="row">
	<div id="compsup" class="col-md-3" style="width:35%;padding-bottom:30px;border-style: groove;">
		<p style="margin-top:-30px; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">&nbsp;</span></p><p style="margin-top:0pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="height:0pt; display:block; position:absolute; z-index:-1"></span><span style="font-family:&#39;Times New Roman&#39;">&nbsp;</span></p><p style="margin-top:5.4pt; margin-left:5.75pt; margin-bottom:0pt; text-indent:15.55pt; line-height:10.05pt; widows:0; orphans:0"><span style="font-family:&#39;Times New Roman&#39;; font-size:9pt; font-weight:bold">Valid.</span><span style="font-family:&#39;Times New Roman&#39;; font-size:9pt; font-weight:bold"> </span><span style="font-family:&#39;Times New Roman&#39;; font-size:9pt; font-weight:bold">superviseur</span></p><p style="margin-top:0pt; margin-bottom:0pt; text-indent:21.3pt; line-height:9.8pt; widows:0; orphans:0">
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['supervisordate'])) { echo $_POST['supervisordate']; } ?></span>
		...
		<br>
		<br>
		<p style="margin:0pt 0pt 0pt 5.75pt; text-indent:15.55pt; line-height:150%; widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">OM récupéré par (date/sign)</span></p><p style="margin-top:0pt; margin-bottom:0pt; text-indent:21.3pt; line-height:9.8pt; widows:0; orphans:0">
        <span style="font-family:'Times New Roman'"></span>
	   </p>
	   <br><br></div>
	<div class="col-md-3">
...
<span style="font-family:'Times New Roman';margin-left:40px;"><?php if (isset($_POST['dateheuredispprev'])) { $DHsansT =str_replace('T',' ',$_POST['dateheuredispprev']); echo $DHsansT; } ?></span>
...
<span style="font-family:'Times New Roman';margin-left:40px;"><?php if (isset($_POST['dhretbaseprev'])) {$DHsansT =str_replace('T',' ',$_POST['dhretbaseprev']); echo $DHsansT; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['heuressup'])) { echo $_POST['heuressup']; } ?></span>
		...
		<p style="margin-top:0pt; margin-left:20.9pt; margin-bottom:0pt; line-height:195%; widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Amblancier2 : </span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dharrivelieu'])) {$DHsansT =str_replace('T',' ',$_POST['dharrivelieu']); echo $DHsansT;  } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dhdepartlieu'])) { $DHsansT =str_replace('T',' ',$_POST['dhdepartlieu']); echo $DHsansT; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dharrivedest'])) { $DHsansT =str_replace('T',' ',$_POST['dharrivedest']); echo $DHsansT; } ?></span>
		</p><p style="margin:3.65pt 120.4pt 0pt 238.7pt; text-indent:-224.5pt; line-height:189%; widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold; color:#00b050">Re</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold; color:#00b050">-départ pour retour:</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold; color:#00b050">&nbsp; </span>
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dhredepart'])) { $DHsansT =str_replace('T',' ',$_POST['dhredepart']); echo $DHsansT; } ?></span>
		</p><p style="margin:3.65pt 120.4pt 0pt 238.7pt; text-indent:-224.5pt; line-height:189%; widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold; color:#00b050">2</span><span style="font-family:&#39;Times New Roman&#39;; font-size:6pt; font-weight:bold; vertical-align:super; color:#00b050">ème</span><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold; color:#00b050"> arrivée destination:</span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dhdepbase'])) { $DHsansT =str_replace('T',' ',$_POST['dhdepbase']); echo $DHsansT; } ?></span>
		</p><p style="margin:0.1pt 120.4pt 0pt 120.3pt; text-indent:-120.3pt; widows:0; orphans:0; font-size:8pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">&nbsp;</span></p><p style="   font-size:9pt;margin-left:45px;width:120%"><span style="font-family:'Times New Roman'; font-weight:bold">Arrivée base:</span>
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dharrbase'])) {$DHsansT =str_replace('T',' ',$_POST['dharrbase']); echo $DHsansT; } ?></span>
		</p><p style="margin-left:20px;font-size:9pt;width:120%"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Durée totale mission: </span>
