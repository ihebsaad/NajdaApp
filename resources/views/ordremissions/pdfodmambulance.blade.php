...
<span style="font-family:'Times New Roman'; font-weight:bold;">  </span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold; letter-spacing:-0.85pt"> </span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold"></span>O2<span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold; letter-spacing:-0.9pt">   </span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold">:  </span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_O2'])) { echo $_POST['CL_O2']; } else {echo "non";} ?></span>
					<span style="width:18.05pt					; display:inline-block">&#xa0;</span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold">Respirateur</span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold; letter-spacing:-0.8pt"> </span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold">:</span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_respirateur'])) { echo $_POST['CL_respirateur']; } else {echo "non";} ?></span>
			           <span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold">Couveuse</span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold; letter-spacing:-0.25pt"> </span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold">: </span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_couveuse'])) { echo $_POST['CL_couveuse']; } else {echo "non";} ?></span>
					<span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold">PSE</span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold; letter-spacing:-1.45pt"> </span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold">:</span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_pse'])) { echo " oui"; if (isset($_POST['CL_nbpsemax'])) {echo " ;Nombre max de PSE : ".$_POST['CL_nbpsemax'];} } else {echo " non";} ?></span></p>
                      <span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold">Chaise roulante</span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold; letter-spacing:-1.45pt"> </span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold">:</span><span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_chaise_roulante'])) { echo $_POST['CL_chaise_roulante']; } else {echo "non";} ?></span>
	</p>
