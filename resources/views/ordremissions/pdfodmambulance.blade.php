...
<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:12pt"></p>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_decatter'])) { echo $_POST['CL_decatter']; } ?></span>
				<span style="font-family:'Times New Roman'; font-weight:bold">: </span>
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['CL_heure_D_A'])) { echo $_POST['CL_heure_D_A']; } ?></span>
</span>			
</p>
<?php }} ?>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dateheuredep'])) { echo $_POST['dateheuredep']; } ?></span>
		</p>
...
<span style="font-family:'Times New Roman';margin-left:40px;"><?php if (isset($_POST['dateheuredispprev'])) { echo $_POST['dateheuredispprev']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dhdepartmiss'])) { echo $_POST['dhdepartmiss']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dharrivelieu'])) { echo $_POST['dharrivelieu']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($_POST['dharrbase'])) { echo $_POST['dharrbase']; } ?></span>
