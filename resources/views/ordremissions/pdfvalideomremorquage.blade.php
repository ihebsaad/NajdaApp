...
<div class="row" style="margin-bottom: -120px">
	...
	<?php if (isset($omparent['emispar'])) {  ?>
		...
		<span id="Eligne4" style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold">ambulance.transp@medicmultiservices.com</span>
		<?php } ?>
		<?php if ($omparent['emispar'] == "xpress")  { ?>
        <div>
...
<?php if (isset($omparent['prestataire_remorquage']) && !(isset($omparent['type_affectation'])) && !(isset($omparent['prestextern']))) { ?>
		<span style="font-family:'Times New Roman';font-weight: bold;">Prestataire: </span>
			<span id="prestataire_remorquage" style="font-family:'Times New Roman'; "><?php echo $omparent['prestataire_remorquage']; ?></span>
<?php } ?>
<?php if (isset($omparent['type_affectation']) && !(empty($omparent['type_affectation']))) { ?>
		<span style="font-family:'Times New Roman';font-weight: bold;">Prestataire: </span>
			<span id="prestataire_remorquage" style="font-family:'Times New Roman'; "><?php echo $omparent['type_affectation']; ?></span>
<?php } ?>
...
<div class="row" style=" margin-left: 0px; ">
	<p style="margin-top:0pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt"><span style="font-family:'Times New Roman'; font-weight:bold">Véhicule (marque et type) </span><span style="font-family:'Times New Roman'; font-weight:bold"></span><span style="font-family:'Times New Roman'; font-weight:bold">&#xa0;</span><span style="font-family:'Times New Roman'; font-weight:bold">: </span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['vehicule_type'])) { echo $omparent['vehicule_type']; } ?></span>
		<span style="font-family:'Times New Roman'; font-weight:bold">Immatriculation</span><span style="font-family:'Times New Roman'">&#xa0;</span><span style="font-family:'Times New Roman'">:   </span><span style="font-family:'Times New Roman'; "><span style="font-family:'Times New Roman'"><?php if (isset($omparent['vehicule_immatriculation'])) { echo $omparent['vehicule_immatriculation']; } ?></span>
				 </span>
	</p>
</div>
<div class="row" style=" margin-left: 0px; ">
	<p style="margin-top:0pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt">
	<p style="margin-top:0pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt"><span style="font-family:'Times New Roman'; font-weight:bold">Boite de vitesse</span><span style="font-family:'Times New Roman'; font-weight:bold"></span><span style="font-family:'Times New Roman'; font-weight:bold">&#xa0;</span><span style="font-family:'Times New Roman'; font-weight:bold">: </span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_automatique_normal'])) { echo $omparent['CL_automatique_normal']; } ?></span>:
...
<?php }} ?>
<div class="row" style=" margin-left: 0px; ">
			<p style="margin-top:0.65pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt"><span style="font-family:'Times New Roman'; font-weight:bold">RDV avec </span><span style="font-family:'Times New Roman'; font-weight:bold">le passager</span><span style="font-family:'Times New Roman'; font-weight:bold">&#xa0;</span><span style="font-family:'Times New Roman'; font-weight:bold">: </span><span style="font-family:'Times New Roman'; font-weight:bold"><?php if (isset($omparent['CL_heure_RDV'])) { echo $omparent['CL_heure_RDV']; } ?></span>
...
<?php }} ?>
<?php if (isset($omparent['CB_trpersonne'])) { if (($omparent['CB_trpersonne'] === "oui")||($omparent['CB_trpersonne'] === "on")) { ?>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_infospersonne'])) { echo $omparent['CL_infospersonne']; } ?></span>
</span>
</p>
<?php }} ?>
<?php if (isset($omparent['CB_pregoulette'])) { if (($omparent['CB_pregoulette'] === "oui")||($omparent['CB_pregoulette'] === "on")) { ?>
<p style="margin-top:4.65pt; margin-left:5.85pt;margin-bottom:0pt; widows:0; orphans:0; font-size:10pt">
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_nombateau'])) { echo $omparent['CL_nombateau']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_heure_D'])) {  if($omparent['CL_heure_D'] ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($omparent['CL_heure_D']));} } ?></span>
</span>			
</p>
<?php }} ?>
<?php if (isset($omparent['CB_prerades'])) { if (($omparent['CB_prerades'] === "oui")||($omparent['CB_prerades'] === "on")) { ?>
<p style="margin-top:4.65pt; margin-left:5.85pt;margin-bottom:0pt; widows:0; orphans:0; font-size:10pt">
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_type_rapatriement'])) { echo $omparent['CL_type_rapatriement']; } ?></span>
</span>
</p>
<?php }} ?>

<?php if (isset($omparent['CB_pregoulette']) || isset($omparent['CB_prerades'])) { 
if (isset($omparent['CB_pregoulette'])) {if ($omparent['CB_pregoulette'] === "oui"||($omparent['CB_pregoulette'] === "on")) {$affport=true;}}
if (isset($omparent['CB_prerades'])) {if ($omparent['CB_prerades'] === "oui"||($omparent['CB_prerades'] === "on")) {$affport=true;}}
	if (isset($affport)){ ?>
...
<div id="prestinterne" >
					<p style="margin-top:-10pt; margin-bottom:0pt; widows:0; orphans:0; padding-bottom:1pt; font-size:10pt"><span style="font-family:'Times New Roman'; font-weight:bold; ">&#xa0;</span></p><p style="margin-top:0pt; margin-left:5.85pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt;border-top: 1.5pt solid #000000;padding-top:10px"><span style="font-family:'Times New Roman'; font-weight:bold">Origine de la demande: </span><span style="font-family:'Times New Roman'; font-weight:bold; ">
...
<p style="margin-top:10px; margin-bottom:0pt; line-height:4.05pt; widows:0; orphans:0"><span style="font-family:&#39;Times New Roman&#39;; font-size:9pt; font-weight:bold;margin-top:5px!important; ">Edité.par</span><br><br><br><span style="left:25pt; font-family:'Times New Roman';font-size:9pt"><?php if (isset($omparent['editepardate'])) { echo $omparent['editepardate']; } ?></span></p>
		...
		<p style=" margin-top:7px; widows:0; orphans:0; font-size:9pt;font-family:&#39;Times New Roman&#39;; font-weight:bold">OM remis par (date/sign)<br><span style="font-size:9pt;font-weight:normal; font-family:'Times New Roman';left:25pt;"><?php if (isset($omparent['remispardate'])) { echo $omparent['remispardate']; } ?></span></p>
...
<div id="deroulmiss" class="deroulmiss col-md-3" style="margin-top:-150px;margin-left:20px;top: 124px!important;width:35%;padding-bottom:5px;border-style: groove;z-index:1000;font-size:9pt"><p style="margin-left:3.9pt; margin-bottom:0pt; widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold; text-decoration:underline">Déroulement mission</span></p><p style="margin-top:2.15pt; margin-left:3.9pt; margin-bottom:0pt;  widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Départ pour mission: </span>
