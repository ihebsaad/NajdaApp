...
<?php if (isset($omparent['prestataire_ambulance']) && !(isset($omparent['type_affectation'])) && !(isset($omparent['prestextern']))) { ?>
		<span style="font-family:'Times New Roman';font-weight: bold;">Prestataire: </span>
			<span id="prestataire_ambulance" style="font-family:'Times New Roman'; "><?php echo $omparent['prestataire_ambulance']; ?></span>
<?php } ?>
...
<?php } ?>
			...
			<p style="text-align: right!important; margin-top:0.6pt;  font-size:10pt"><span style="font-family:'Times New Roman'">Transfert:&#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_transfert'])) { echo $omparent['CL_transfert']; } else {echo "non";} ?></span>
...
<p style="margin-top:0.05pt; margin-bottom:0pt; widows:0; orphans:0; font-size:9pt"><span style="font-family:'Times New Roman';font-weight:bold">Type d'ambulance : &#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_type_ambulance'])) { echo $omparent['CL_type_ambulance']; } ?></span>
...
<span style="font-family:'Times New Roman'; font-weight:bold;">  </span>  <span style="font-family:'Times New Roman'; font-size:9pt; font-weight:bold">O2 : </span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold"> </span><span style="font-family:'Times New Roman';font-size:9pt"><?php if (isset($omparent['CL_O2'])) { echo $omparent['CL_O2']; } else {echo "non";} ?></span>
					<span style="font-family:'Times New Roman'; font-size:9pt; font-weight:bold"> Respirateur : </span><span style="font-family:'Times New Roman'; font-size:9pt"><?php if (isset($omparent['CL_respirateur'])) { echo $omparent['CL_respirateur']; } else {echo "non";} ?></span>
			          <span style="font-family:'Times New Roman'; font-size:9pt; font-weight:bold"> Couveuse : </span><span style="font-family:'Times New Roman'; font-size:9pt"> <?php if (isset($omparent['CL_couveuse'])) { echo $omparent['CL_couveuse']; } else {echo "non";} ?></span>
					<span style="font-family:'Times New Roman'; font-size:9pt; font-weight:bold"> PSE : </span><span style="font-family:'Times New Roman'; font-size:9pt"> <?php if (isset($omparent['CL_pse'])) { echo " oui"; if (isset($omparent['CL_nbpsemax'])) {echo " ;Nombre max de PSE : ".$omparent['CL_nbpsemax'];} } else {echo " non";} ?></span>
                      <span style="font-family:'Times New Roman'; font-size:9pt; font-weight:bold"> Chaise roulante : </span><span style="font-family:'Times New Roman'; font-size:9pt"><?php if (isset($omparent['CL_chaise_roulante'])) { echo $omparent['CL_chaise_roulante']; } else {echo "non";} ?></span>
	</p>
...
<?php if (isset($omparent['CB_escorte'])) { if (($omparent['CB_escorte'] === "oui")||($omparent['CB_escorte'] === "on")) { ?>
<p style="margin-top:0.05pt;margin-bottom:0pt; widows:0; orphans:0; font-size:9pt">
...
<span style="font-family:'Times New Roman';font-weight:bold"><?php if (isset($omparent['CL_decatter'])) { echo $omparent['CL_decatter']; } ?></span>
				<span style="font-family:'Times New Roman'; font-weight:bold">: </span>
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_heure_D_A'])) { if($omparent['CL_heure_D_A'] ==='') {echo '';} else {echo date('d/m/Y H:i:s', strtotime($omparent['CL_heure_D_A']));} } ?></span>
</span>			
</p>
<?php }} ?>
...
<span style="font-family:'Times New Roman';font-weight:bold"><?php if (isset($omparent['CL_type_siege'])) { echo $omparent['CL_type_siege']; } ?>: <?php if (isset($omparent['CL_oxygene'])) { echo $omparent['CL_oxygene']; } else {echo "";} ?></span>
...
<span style="font-family:'Times New Roman';margin-left:40px;"><?php if (isset($omparent['dateheuredispprev'])) { $DHsansT =str_replace('T',' ',$omparent['dateheuredispprev']); echo date('d/m/Y H:i:s', strtotime($DHsansT));  } ?></span></p>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['lparamed'])) { echo $omparent['lparamed']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['lambulancier1'])) { echo $omparent['lambulancier1']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['lambulancier2'])) { echo $omparent['lambulancier2']; } ?></span>
			</p><p style="margin-top:0.05pt; margin-left:3.9pt; margin-bottom:0pt;  widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Heures sup ?: </span>
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['heuressup2'])) { echo $omparent['heuressup2']; } ?></span>
			</p>
	</div>
