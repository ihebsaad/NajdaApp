...
<div class="row" style="margin-bottom: -120px">
	...
	<?php if (isset($omparent['emispar'])) {  ?>
		...
		<span id="Eligne1" style="font-family:'Times New Roman'; font-weight:bold">Rue Mohamed Hamdane - Sahloul III</span>
				</p><p style="margin-top:2.7pt; margin-left:5.85pt; margin-bottom:0pt; widows:0; orphans:0; font-size:6.5pt">
...
<p style="margin-top:6.95pt; margin-bottom:0pt; widows:0; orphans:0; font-size:11pt"><span style="font-family:'Times New Roman';font-weight:bold">Type d'ambulance : &#xa0;</span><span style="font-family:'Times New Roman'"><?php if (isset($omparent['CL_type_ambulance'])) { echo $omparent['CL_type_ambulance']; } ?></span>
...
<span style="font-family:'Times New Roman'; font-weight:bold;">  </span>  <span style="font-family:'Times New Roman'; font-size:10pt; font-weight:bold">O2 : </span><span style="font-family:'Times New Roman'; font-size:8pt; font-weight:bold"> </span><span style="font-family:'Times New Roman';font-size:10pt"><?php if (isset($omparent['CL_O2'])) { echo $omparent['CL_O2']; } else {echo "non";} ?></span>
					<span style="font-family:'Times New Roman'; font-size:10pt; font-weight:bold"> Respirateur : </span><span style="font-family:'Times New Roman'; font-size:10pt"><?php if (isset($omparent['CL_respirateur'])) { echo $omparent['CL_respirateur']; } else {echo "non";} ?></span>
			          <span style="font-family:'Times New Roman'; font-size:10pt; font-weight:bold"> Couveuse : </span><span style="font-family:'Times New Roman'; font-size:10pt"> <?php if (isset($omparent['CL_couveuse'])) { echo $omparent['CL_couveuse']; } else {echo "non";} ?></span>
					<span style="font-family:'Times New Roman'; font-size:10pt; font-weight:bold"> PSE : </span><span style="font-family:'Times New Roman'; font-size:10pt"> <?php if (isset($omparent['CL_pse'])) { echo " oui"; if (isset($omparent['CL_nbpsemax'])) {echo " ;Nombre max de PSE : ".$omparent['CL_nbpsemax'];} } else {echo " non";} ?></span>
                      <span style="font-family:'Times New Roman'; font-size:10pt; font-weight:bold"> Chaise roulante : </span><span style="font-family:'Times New Roman'; font-size:10pt"><?php if (isset($omparent['CL_chaise_roulante'])) { echo $omparent['CL_chaise_roulante']; } else {echo "non";} ?></span>
	</p>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['supervisordate'])) { echo $omparent['supervisordate']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['remispardate'])) { echo $omparent['remispardate']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['recuperepardate'])) { echo $omparent['recuperepardate']; } ?></span>
	</p></div>
	<div class="col-md-3">
	</div>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dateheuredep'])) { echo $omparent['dateheuredep']; } ?></span>
...
<span style="font-family:'Times New Roman';margin-left:40px;"><?php if (isset($omparent['dateheuredispprev'])) { echo $omparent['dateheuredispprev']; } ?></span>
...
<span style="font-family:'Times New Roman';margin-left:40px;"><?php if (isset($omparent['dhretbaseprev'])) { echo $omparent['dhretbaseprev']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['lvehicule'])) { echo $omparent['lvehicule']; } ?></span>
			</p><p style="margin-top:0pt; margin-left:20.9pt; margin-bottom:0pt; line-height:195%; widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Médecin: </span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['lparamed'])) { echo $omparent['lparamed']; } ?></span>
			</p><p style="margin-top:0pt; margin-left:20.9pt; margin-bottom:0pt; line-height:195%; widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">Amblancier1 : </span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dhdepartmiss'])) { echo $omparent['dhdepartmiss']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dharrivelieu'])) { echo $omparent['dharrivelieu']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dhdepartlieu'])) { echo $omparent['dhdepartlieu']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dharrivedest'])) { echo $omparent['dharrivedest']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dhredepart'])) { echo $omparent['dhredepart']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dh2emearrdest'])) { echo $omparent['dh2emearrdest']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dhdepbase'])) { echo $omparent['dhdepbase']; } ?></span>
...
<span style="font-family:'Times New Roman'"><?php if (isset($omparent['dharrbase'])) { echo $omparent['dharrbase']; } ?></span>
