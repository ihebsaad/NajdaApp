...
<input type="hidden" id="idprestmed" name="idprestmed" value="" />
                            ...
                            <div class="panel panel-success " id="technique"  >
                                ...
                                <div class="panel-collapse collapse in">
                                 ...
                                 <select onchange="modif_prest4(this);"  type="text" id="empalcement3" name="empalcement3" class="form-control"   >
...
<input type="hidden" id="idprestemp3" name="idprestemp3" value="" />
                            ...
                            <select  onchange="modif_prest3(this);"  type="text" id="empalcement2" name="empalcement2" class="form-control"   >
...
<input type="hidden" id="idprestemp2" name="idprestemp2" value="" />
                ...
                <select   onchange="modif_prest2(this);" type="text" id="empalcement" name="empalcement" class="form-control"   >
