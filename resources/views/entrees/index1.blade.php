        ...
        <table class="table table-striped" id="mytable" style="width:100%">
            ...
            @foreach($entrees as $entree)
                <tr><?php $type=$entree['type'];
                    ...
                    <td  style="width:35%;font-size:12px;max-width:200px;"><a style="<?php echo $style;?>"  <?php if ($entree['dossier']!='') {  ?>   href="<?php echo $urlapp.'/entrees/show/',$entree['id']?>" <?php } else{  ?> href= "<?php echo $urlapp.'/entrees/showdisp/',$entree['id']?>"    <?php } ?>     ><?php echo iconv_mime_decode( nl2br(strval(utf8_encode( preg_replace("/[^A-Za-z0-9()\/ <>~@|#,;?:!-+.*àç=_è-é&]/", '',$entree['sujet'] ) ))))  ; ?></a></td>
