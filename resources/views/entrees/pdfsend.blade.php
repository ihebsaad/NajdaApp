                                ...
                                <table  width="400" class="w320">
                                    <tr>
                                        <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
                                            <label style="font-size:16px;color:#4fc1e9;">Destinataire:</label><label style="font-size:16px;color:#000000!important"> {{ $envoye->destinataire   }}</label>
                                        </td>
                                        <td class="pull-right mobile-header-padding-right" >
                                            <label style="font-size:16px;color:#4fc1e9;">Date:</label><label style="font-size:16px;color: #000000 !important;"> <?php echo  date('d/m/Y H:i', strtotime( $envoye->created_at  )) ; ?></label> </td>
        ...
        <td align="center"  width="100%" heigh="100%" style="background-color: #f7f7f7;" class="content-padding">
            <center>
                <table  width="100%" >
                    <tr>
                        <td class="header-lg">
                            <span style="color:#fd9883"> Sujet : {{$envoye->sujet}}</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="free-text">
                            ...
                            @if (!empty($envoye->dossier))
                                 <b>REF Dossier: {{ $envoye->dossier   }}</b>
                            @endif
                        </td>
                    </tr>
                    <tr>
