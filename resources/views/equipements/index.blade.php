...
@section('content')
    ...
    <div class="uper">
        ...
        <div class="portlet box grey">
            <div class="row">
                <div class="col-lg-6">Equipements</div>
                <div class="col-lg-6">
                    <button id="addgr" class="btn btn-md btn-success"   data-toggle="modal" data-target="#create"><b><i class="fas fa-plus"></i> Ajouter un equipement</b></button>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="adde" class="btn btn-primary">Ajouter</button>
                </div>
            </div>
        </div>
    </div>
...
// Apply the search
            ...
            $('#adde').click(function(){
                ...
                if ((nom != '')  )
                {
                    ...
                    $.ajax({
                        url:"{{ route('equipements.saving') }}",
                        method:"POST",
                        data:{nom:nom,numero:numero,reference:reference, _token:_token},
