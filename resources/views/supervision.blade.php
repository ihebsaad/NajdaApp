                           ...
                           <!-- <h4>Supervision</h4><br>-->
                            ...
                            foreach($users as $user)
                                { if($c % 2 ==0){$bg='background-color:#dddcda!important';}else{$bg='';}
                                  ...
                                  if(/*$user->isOnline()  && */ $user->statut== 1 &&  $user->user_type!= 'financier' && $user->user_type!= 'bureau' && $user->user_type!= 'admin' && $user->id != 2) {$style=''; if($dureeactives >20){$style='background-color:#fd9883;color:white;';}    if($user->statut==2){$style='background-color:#FFCE54;color:black;';}
			...
			<div class="panel panel-danger col-md-5" style="padding:0 ; ">
                   ...
                   <div class="panel-body scrollable-panel" style="display: block;">
                    ...
                    <?php   foreach($users as $user)
                       ...
                       if(/*$user->isOnline() &&*/ $user->statut== 1 && $user->user_type!= 'bureau' && $user->user_type!= 'financier' && $user->user_type!= 'admin' && $user->id!= 2) {
                           $c++;?>
