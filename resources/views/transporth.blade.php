...
$datedebut1= date('d/m/Y,H:i', strtotime($datedebut));
$datefin1= date('d/m/Y,H:i', strtotime($datefin));
...
<?php if($datedebut1 !==$dateorigine){ ?>
 <div class="row" style="margin-bottom:10px">
  <div class="col-md-12" > <i class="fas fa-calendar-o"></i> <small>Date départ base:</small>  <?php echo $datedebut1; ?> </div>
                                                          </div>
<?php } ?>
<?php if($datefin1 !==$dateorigine){ ?>
                                                         <div class="row" style="margin-bottom:10px">
                                                              <div class="col-md-12"  ><i class="fas fa-calendar-check-o"></i> <small>Date dispo prévisible:</small>  <?php echo $datefin1; ?> </div>
                                                          </div>
							<?php } ?>
<?php } ?>
...
<?php } ?>
               ...
               <?php if($datefin1 !==$dateorigine){ ?>                                          <div class="row" style="margin-bottom:10px">
                                                              <div class="col-md-12"  ><i class="fas fa-calendar-check-o"></i> <small>Date dispo prévisible:</small>  <?php echo $datefin1; ?> </div>
                                                          </div>
				<?php } ?>
<?php } ?>
...
$dateorigine ='01/01/1970,01:00';
                               if($type=='taxi'){  $chauff=$o['lchauff'];$color='#D4AC0D';$icon='<i class="fas fa-2x fa-taxi"></i>';$prestom=$o['prestataire_taxi'];}
                               if($type=='ambulance'){  $chauff=$o['lambulancier1'];  $chauff=$o['lambulancier1'];  $color='#2874A6';$icon='<i class="fas fa-2x fa-ambulance"></i>';$prestom=$o['prestataire_ambulance'];}
                               if($type=='remorquage'){  $chauff=$o['lchauff'];$color='#C0392B';$icon='<i class="fas fa-2x fa-truck-pickup"></i>';$prestom=$o['prestataire_remorquage'];}
                               if($hour>10 && $hour<14)
