...
<div class="clearfix sipStatus">
    ...
    <div class="form-group" id="phoneUI">
        <div class="input-group">
			...
			<?php if (isset($_GET['num'])) {$num=$_GET['num']; }else{$num='';}  ?>
        <input type="text" name="number" id="numDisplay" class="form-control text-center input-sm" value="<?php echo $num;?>" placeholder="Enter number..." autocomplete="off" />
