...
$sqlvh = "SELECT id,name,prenom,civilite,phone_home,ville,ville_id FROM prestataires WHERE id IN (SELECT prestataire_id FROM prestations WHERE dossier_id=".$iddossier." AND effectue= 1) AND (id IN (SELECT prestataire_id FROM prestataires_type_prestations WHERE type_prestation_id = 61) OR id IN (SELECT prestataire_id FROM specialites_prestataires WHERE specialite = 31))";
...
{
?>
<p class=rvps7><span class=rvts6>*Nom patient :<select id="subscriber__name" name="subscriber__name" autocomplete="off"  >
            <?php
...
<p class=rvps7><span class=rvts6>*Prénom : <select id="subscriber__lastname" name="subscriber__lastname" autocomplete="off"  >
            <?php
...
{
?>
<p class=rvps7><span class=rvts6>*Nom patient : <input name="subscriber__name" id="subscriber__name" placeholder="prénom du l'abonnée" value="<?php if(isset ($detaildos['subscriber_name'])) echo $detaildos['subscriber_name']; ?>" /> </span></p>
<p class=rvps7><span class=rvts6>*Prénom : <input id="subscriber__lastname"  name="subscriber__lastname" placeholder="nom du l'abonnée"  value="<?php  if(isset ($detaildos['subscriber_lastname'])) echo $detaildos['subscriber_lastname']; ?>"/> </span></p>
  <?php
}
?>
