...
<p class=rvps4><span class=rvts1>Sousse le <input name="date_heure" type="text" value="<?php if(isset ($date_heure)) echo $date_heure; ?>"></input></span></p>
...
<p class=rvps7><span class=rvts10>Notre référence dossier :</span><span class=rvts9>&nbsp; </span><span class=rvts7><input name="reference_medic" placeholder="Notre Reference" value="<?php if(isset ($reference_medic)) echo $reference_medic; ?>"></input></span></p>
