...
<p class=rvps6><span class=rvts9>Date début de location: <input name="CL_date_debut_location" placeholder="Date Debut Location" value="<?php if(isset ($CL_date_debut_location)) echo $CL_date_debut_location; ?>"></input>RDV avec l</span><span class=rvts10>’</span><span class=rvts9>assuré: <input name="CL_heure" placeholder="Heure" value="<?php if(isset ($CL_heure)) echo $CL_heure; ?>"></input></span></p>
