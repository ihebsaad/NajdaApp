...
$sqlvh = "SELECT id,name,prenom,civilite,phone_home,ville,ville_id FROM prestataires WHERE id IN (SELECT prestataire_id FROM prestations WHERE dossier_id=".$iddossier." AND effectue= 1)AND id IN (SELECT prestataire_id FROM prestataires_type_prestations WHERE type_prestation_id = 32)";
...
<select id="prest__pompes" name="prest__pompes" autocomplete="off" onchange="prestchange();" >
<?php
...
{
?>
<p class=rvps5><span class=rvts5>*Nom patient :</span><span class=rvts6> <select id="subscriber__name" name="subscriber__name" autocomplete="off"  >
            <?php
...
?>
</select> </span><span class=rvts5> </span><span class=rvts7> </span></p>
    <p class=rvps5><span class=rvts5>*Prénom :</span><span class=rvts6> <select id="subscriber__lastname" name="subscriber__lastname" autocomplete="off"  >
            <?php
...
{
?>
<p class=rvps5><span class=rvts5>*Nom patient :</span><span class=rvts6><input name="subscriber__name" id="subscriber__name" placeholder="prénom du l'abonnée" value="<?php if(isset ($detaildos['subscriber_name'])) echo $detaildos['subscriber_name']; ?>" /> </span><span class=rvts5> </span><span class=rvts7> </span></p>
    <p class=rvps5><span class=rvts5>*Prénom :</span><span class=rvts6> <input id="subscriber__lastname"  name="subscriber__lastname" placeholder="nom du l'abonnée"  value="<?php  if(isset ($detaildos['subscriber_lastname'])) echo $detaildos['subscriber_lastname']; ?>"/></span></p>

    <?php
}
?>
    <p><span class=rvts7>*Notre réf. dossier</span><span class=rvts8>: </span><span class=rvts7><input name="reference_medic" placeholder="reference" value="<?php if(isset ($reference_medic)) echo $reference_medic; ?>"></input> |<input name="subscriber_lastname2" placeholder="nom du l'abonnée"  value="<?php if(isset ($detaildos['subscriber_lastname'])) echo $detaildos['subscriber_lastname']; ?>"></input/> <input name="subscriber_name2" id="subscriber_name2" placeholder="prénom du l'abonnée" value="<?php if(isset ($detaildos['subscriber_name'])) echo $detaildos['subscriber_name']; ?>" /> </span><span class=rvts8> </span></p>
...
if (obj.value > 0)
 ...
 var e = document.getElementById("prest__pompes");
