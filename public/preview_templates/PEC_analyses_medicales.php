...
$sqlvh = "SELECT id,name,prenom,civilite,phone_home,ville,ville_id FROM prestataires WHERE id IN (SELECT prestataire_id FROM prestations WHERE dossier_id=".$iddossier." AND effectue= 1 ) AND id IN (SELECT prestataire_id FROM prestataires_type_prestations WHERE type_prestation_id = 7)";
...
{
?>
<p class=rvps4><span class=rvts5>Nom patient</span><span class=rvts6> : <select id="subscriber__name" name="subscriber__name" autocomplete="off"  >
            <?php
...
<p class=rvps4><span class=rvts7>Prénom</span><span class=rvts8> : <select id="subscriber__lastname" name="subscriber__lastname" autocomplete="off"  >
            <?php
...
{
?>
<p class=rvps4><span class=rvts5>Nom patient</span><span class=rvts6> : <input name="subscriber__name" id="subscriber__name" placeholder="prénom du l'abonnée" value="<?php if(isset ($detaildos['subscriber_name'])) echo $detaildos['subscriber_name']; ?>" />  </span></p>
<p class=rvps4><span class=rvts7>Prénom</span><span class=rvts8> : <input id="subscriber__lastname"  name="subscriber__lastname" placeholder="nom du l'abonnée"  value="<?php  if(isset ($detaildos['subscriber_lastname'])) echo $detaildos['subscriber_lastname']; ?>"/></span></p>
<?php
}
?>
...
// initialisation id prestataires
        ...
        var e = document.getElementById("prest__labmed");
