...
$sqlvh = "SELECT id,name,phone_home,ville,ville_id FROM prestataires WHERE id IN (SELECT prestataire_id FROM prestations WHERE dossier_id=".$iddossier." AND effectue= 1 ) AND id IN (SELECT prestataire_id FROM prestataires_type_prestations WHERE type_prestation_id = 7)";
...
<input type="text" list="prest__labmed" name="prest__labmed"  value="<?php if(isset ($prest__labmed)) echo $prest__labmed; ?>" />
        <datalist id="prest__labmed">
            <?php
...
?>
<p class=rvps4><span class=rvts5>Nom patient</span><span class=rvts6> : <input name="subscriber_name" placeholder="prenom du l'abonnée"  value="<?php if(isset ($subscriber_name)) echo $subscriber_name; ?>"></input>  </span></p>
<p class=rvps4><span class=rvts7>Prénom</span><span class=rvts8> : <input name="subscriber_lastname" placeholder="nom du l'abonnée"  value="<?php if(isset ($subscriber_lastname)) echo $subscriber_lastname; ?>"></input></span></p>
<p class=rvps4><span class=rvts7>Notre réf. dossier</span><span class=rvts8> : <input name="reference_medic" placeholder="Notre Reference" value="<?php if(isset ($reference_medic)) echo $reference_medic; ?>"></input> |  <input name="subscriber_lastname2" placeholder="nom du l'abonnée"  value="<?php if(isset ($subscriber_lastname2)) echo $subscriber_lastname2; ?>"></input></span></p> <input name="subscriber_name2" id="subscriber_name2" placeholder="prénom du l'abonnée" value="<?php if(isset ($subscriber_name2)) echo $subscriber_name2; ?>" />
...
document.querySelector('input[list="prest__labmed"]').addEventListener('input', onInput);
