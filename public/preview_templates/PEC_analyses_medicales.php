...
<p class=rvps4><span class=rvts7>Prénom</span><span class=rvts8> : <input name="subscriber_name" placeholder="prenom du l'abonnée"  value="<?php if(isset ($subscriber_name)) echo $subscriber_name; ?>"></input></span></p>
