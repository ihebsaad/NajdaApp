...
<select id="inter__medecin" name="inter__medecin" autocomplete="off" onchange="prestchange();" >
<?php
...
// initialisation id prestataires
        ...
        var e = document.getElementById("inter__medecin");
