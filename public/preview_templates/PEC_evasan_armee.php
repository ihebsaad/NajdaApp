...
<p class=rvps1><span class=rvts6>Cette équipe se présentera à bord de </span><span class=rvts8>l</span><span class=rvts12>’</span><span class=rvts8>ambulance</span><span class=rvts6> de Medic</span><span class=rvts9>’</span><span class=rvts6> Multiservices, immatriculée</span><span class=rvts11>  <input name="vehicule_immatriculation" id="vehicule_immatriculation" placeholder="Immatriculation Vehicule" value="<?php if(isset ($vehicule_immatriculation)) echo $vehicule_immatriculation; ?>" /></span><span class=rvts8>.</span><span class=rvts6> Elle devrait se présenter à l</span><span class=rvts9>’</span><span class=rvts6>entrée de la base le </span><span class=rvts11><input name="CL_date_heure_entree_base" placeholder="Date Heure Entree Base" value="<?php if(isset ($CL_date_heure_entree_base)) echo $CL_date_heure_entree_base; ?>"></input></span></p>
