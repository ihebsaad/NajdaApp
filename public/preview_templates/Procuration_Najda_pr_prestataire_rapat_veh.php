...
<p class=rvps4><span class=rvts2>Nous soussignés, </span><span class=rvts7>Najda Assistance</span><span class=rvts2>, société d</span><span class=rvts8>’</span><span class=rvts2>assistance correspondante pour la Tunisie de la compagnie   <input name="customer_id__name" id="customer_id__name" placeholder="compagnie" value="<?php if(isset ($customer_id__name)) echo $customer_id__name; ?>" /> </span><span class=rvts9> </span><span class=rvts2>attestons par la présente que notre prestataire technique la société </span><span class=rvts9>prestataire dossier</span><span class=rvts10> </span><span class=rvts9>est</span><span class=rvts2> chargé par nos soins de procéder au rapatriement du véhicule <input name="vehicule_marque" placeholder="marque du véhicule" value="<?php if(isset ($vehicule_marque)) echo $vehicule_marque; ?>"></input> <input name="vehicule_type" placeholder="Type du véhicule" value="<?php if(isset ($vehicule_type)) echo $vehicule_type; ?>"></input> immatriculé <input name="vehicule_immatriculation" placeholder="immatriculation" value="<?php if(isset ($vehicule_immatriculation)) echo $vehicule_immatriculation; ?>"></input>.</span></p>
...
<p><span class=rvts2><br></span></p>
<p><span class=rvts2>&nbsp;&nbsp;&nbsp; </span><img width=142 height=181 alt="" style="padding : 1px;" src="y1i7r0irwhmejpqnhu562iunmlpgksj9_Procuration_Najda_pr_prestataire_rapat_veh/img1.jpg"></p>
