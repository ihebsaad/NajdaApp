...
<p style="margin-top:20px!important;margin-left:7.85pt; margin-bottom:0pt; widows:0; orphans:0; font-size:12pt"><span style="font-family:'Times New Roman'; font-weight:bold; font-style:italic; color:#000000">Le présent ordre de mission fait office de prise en charge et copie doit être adressée avec votre facture</span></p>
        ...
        <?php if (isset($_GET['complete']) ){ ?>
            ...
            <div class="row">
                <div id="compsup" class="col-md-3">
                    ...
                    </p><p style="margin:0pt 0pt 0pt 5.75pt; text-indent:15.55pt; line-height:150%; widows:0; orphans:0; font-size:9pt"><span style="font-family:&#39;Times New Roman&#39;; font-weight:bold">OM récupéré par (date/sign)</span></p><p style="margin-top:0pt; margin-bottom:0pt; text-indent:21.3pt; line-height:5.8pt; widows:0; orphans:0">
...
/*$("input[list='lchauff']").focusin( function (event) {
	event.preventDefault();
        verifdisppersonnel();
	    /*verifamb2();
	    verifparamed();
