...
{
?>
<p class=rvps5><span class=rvts8>Nom Assuré</span><span class=rvts9> : <select id="subscriber__name" name="subscriber__name" autocomplete="off"  >
            <?php
...
<p class=rvps5><span class=rvts8>Nom Assuré</span><span class=rvts9> : <input name="subscriber__name" id="subscriber__name" placeholder="prénom du l'abonnée" value="<?php if(isset ($detaildos['subscriber_name'])) echo $detaildos['subscriber_name']; ?>" /> </span></p>
